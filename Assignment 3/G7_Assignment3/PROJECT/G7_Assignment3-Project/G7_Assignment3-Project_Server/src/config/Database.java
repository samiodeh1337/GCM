...
public final class Database {
	...
	public static final String DB_DEFAULT_PASSWORD = "Aa123456";
	
	/** The Constant DB_DEFAULT_SERVERTIMEZONE. */
	public static final String DB_DEFAULT_SERVERTIMEZONE = "IST";
	
	/** The Constant DB_DEFAULT_ALLOWMULTIQUERIES. */
	public static final boolean DB_DEFAULT_ALLOWMULTIQUERIES = true;
