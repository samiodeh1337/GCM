		...
		Platform.runLater(new Runnable() {
			...
			public void run() {
				...
				if(msg instanceof String) {
					System.out.println("ClientService: packet received from server: " + (String)msg);
					try {
						ResponseHandler.responseHandler(AbstractJsonToString.toObject(entities.Packet.class, (String)msg));
					} catch (Exception ex) {
